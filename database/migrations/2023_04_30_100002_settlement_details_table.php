...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('settlement_details', function (Blueprint $table) {
            ...
            $table->foreignId('payer_id')->constrained()->onDelete('cascade')->references('id')->on('users');
            $table->foreignId('payee_id')->constrained()->onDelete('cascade')->references('id')->on('users');
